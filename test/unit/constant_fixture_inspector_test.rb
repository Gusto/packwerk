...
require "test_helper"
require "packwerk/constant_fixture_inspector"
require "parser_test_helper"

module Packwerk
  class ConstantFixtureInspectorTest < ActiveSupport::TestCase
    setup do
      @inspector = ConstantFixtureInspector.new("test/fixtures/skeleton")
    end
